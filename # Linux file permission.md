...
![output of ls -l command](output of ls -l command.png)
...
The following code demonstrates how I used Linux commands to do this:
 ...
 ![output of chmod command](output of chmod command.png)
...
![output of chmod hidden filecommand](output of chmod hidden file command.png)
...
The following code demonstrates how I used Linux commands to change the permissions:
 ...
 ![output of chmod directory command](output of chmod directory command.png)
